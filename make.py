...
if s_l == "p":
 os.system("pip uninstall -y pyrogram && pip install https://github.com/TelegramPlayGround/pyrogram/archive/refs/heads/33679-46-1.zip")
 ...
 os.system("pip uninstall -y pyrogram && pip install https://github.com/TelegramPlayGround/pyrogram/archive/refs/heads/33679-46-2.zip")
 print("you selected Pyrogram")
 APP_ID = int(input("Enter APP ID here: "))
 API_HASH = input("Enter API HASH here: ")
 import pyrogram
